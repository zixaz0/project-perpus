...
@section('content')
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Selamat datang, {{ Auth::user()->name }}! Berikut ringkasan bisnis toko buku Anda.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Pendapatan Hari Ini -->
            <div
                class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition">
            ...
            <div
                class="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-sm opacity-90 mb-1">Pendapatan Bulan Ini</p>
                        <h3 class="text-3xl font-bold mb-1">Rp {{ number_format($totalPendapatanBulanIni, 0, ',', '.') }}
                        </h3>
            ...
            <!-- Total Buku -->
            <div
                class="bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
            ...
            <!-- Total Pegawai -->
            <div
                class="bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-xl shadow-lg p-6 transform hover:scale-105 transition">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                    ...
                    @foreach ($metodeBayar as $metode)
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            ...
                            {{ $metode->metode_bayar == 'cash' ? 'bg-green-100 text-green-600' : 'bg-blue-100 text-blue-600' }}">
                                    <i
                                        class="fas {{ $metode->metode_bayar == 'cash' ? 'fa-money-bill' : 'fa-credit-card' }}"></i>
                                </div>
                                <div>
            ...
            <div class="bg-white rounded-xl shadow-md border p-6">
                ...
                <div class="space-y-3">
                    @forelse($bukuTerlaris as $index => $item)
                        <div
                            class="flex items-center gap-4 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-100 hover:shadow-md transition">
                            <!-- Badge Ranking -->
                            <div
                                class="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm shadow">
                                {{ $index + 1 }}
                            </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-600 mt-1">
                                    <span class="inline-flex items-center">
                                        ...
                                        Stok: <span
                                            class="font-semibold ml-1">{{ $item->buku->stokHarga->stok ?? 0 }}</span>
                                    </span>
                ...
                <div class="bg-white rounded-xl shadow-md border p-6">
                    <h2 class="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                        ...
                        Stok Menipis (< 10) </h2>
                            ...
                            <div
                                class="space-y-2 max-h-[400px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                @forelse($stokMenipis as $item)
                                    <div
                                        class="flex items-center gap-3 p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border border-yellow-200 hover:shadow-md transition">
                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="flex-shrink-0 text-right">
                                            <p class="text-xl font-bold text-yellow-600">{{ $item->stokHarga->stok ?? 0 }}
                                            </p>
                ...
                <div class="bg-white rounded-xl shadow-md border p-6">
                    ...
                    <div
                        ...
                        @forelse($stokHabis as $item)
                            <div
                                class="flex items-center gap-3 p-3 bg-gradient-to-r from-red-50 to-pink-50 rounded-lg border border-red-200 hover:shadow-md transition">
                                <div class="flex-shrink-0">
